...
struct excel_info PartInfo[PART_NUM]={
			...
			{"pmt",4194304,0x1100000, EMMC, 0,USER},
			...
			{"android",681574400,0x5180000, EMMC, 5,USER},
			{"cache",132120576,0x2db80000, EMMC, 6,USER},
			{"usrdata",1073741824,0x35980000, EMMC, 7,USER},
			{"fat",0,0x75980000, EMMC, 8,USER},
