...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x76, 0x93);  /// 94    8c  8e

	GC0329_write_cmos_sensor(0x7c, 0x85);  //80
	...
	GC0329_write_cmos_sensor(0x33, 0x18);   ///  20
	GC0329_write_cmos_sensor(0x34, 0x18);
	GC0329_write_cmos_sensor(0x35, 0x18);
	GC0329_write_cmos_sensor(0x36, 0x18);
	GC0329_write_cmos_sensor(0x3b, 0x00);   ///  00
	GC0329_write_cmos_sensor(0x3c, 0x3f);
	GC0329_write_cmos_sensor(0x3d, 0x3f);
	GC0329_write_cmos_sensor(0x3e, 0x01);

	////////////////////ISP BLOCK ENABL////////////////////
	GC0329_write_cmos_sensor(0x40, 0xdf);  //df //ff
	GC0329_write_cmos_sensor(0x41, 0x40);  ///  44  24
	GC0329_write_cmos_sensor(0x42, 0xff);  //fe// 7e  3e
	GC0329_write_cmos_sensor(0x44, 0xa2);  /// a0
	...
	GC0329_write_cmos_sensor(0x82, 0x0c);   ///0e//  55
	GC0329_write_cmos_sensor(0x83, 0x05);  // add by lanking 20120423
	GC0329_write_cmos_sensor(0x87, 0x4a);

	////////////////////INTPEE////////////////////
	GC0329_write_cmos_sensor(0x95, 0x74);  //   54
	GC0329_write_cmos_sensor(0x96, 0x78);  //   88
	...
	GC0329_write_cmos_sensor(0xa2, 0xaa);
	GC0329_write_cmos_sensor(0xa4, 0x50);  //60
	GC0329_write_cmos_sensor(0xa5, 0x31);  //41//31
	...
	////////////////////YCP////////////////////
	GC0329_SET_PAGE0;
	GC0329_write_cmos_sensor(0xd1, 0x3a);  /// 34
	GC0329_write_cmos_sensor(0xd2, 0x3a);
	GC0329_write_cmos_sensor(0xd3, 0x3a);  //// 46
	GC0329_write_cmos_sensor(0xdd, 0x54);  /// 54
	GC0329_write_cmos_sensor(0xde, 0x36); //34
	GC0329_write_cmos_sensor(0xed, 0x01);  /// 
	GC0329_write_cmos_sensor(0xee, 0x20);  /// 
	GC0329_write_cmos_sensor(0xef, 0x30);  /// 

	////////////////////AEC////////////////////
	GC0329_SET_PAGE1;
	GC0329_write_cmos_sensor(0x10, 0x00); //aec after gamma
	GC0329_write_cmos_sensor(0x11, 0x21);
	GC0329_write_cmos_sensor(0x12, 0x27);  //17// 07
	GC0329_write_cmos_sensor(0x13, 0x78);  //4d   80
	GC0329_write_cmos_sensor(0x15, 0xf2);  /// f2
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xe0);  
	GC0329_write_cmos_sensor(0x22, 0x60);   /// 48
	GC0329_write_cmos_sensor(0x3c, 0xe8);  /// 95
	GC0329_write_cmos_sensor(0x3d, 0x60);  /// 50
	GC0329_write_cmos_sensor(0x3e, 0x3f);  /// 48
	...
	GC0329_write_cmos_sensor(0x66, 0xb8);  ///  fa
	...
	GC0329_write_cmos_sensor(0x80, 0x70);  // 60
	GC0329_write_cmos_sensor(0x81, 0x58);  //50
	...
	GC0329_write_cmos_sensor(0x74, 0x32);  // 40
	GC0329_write_cmos_sensor(0x75, 0x40);  /// 58
	GC0329_write_cmos_sensor(0x76, 0x30);  // 24
	GC0329_write_cmos_sensor(0x77, 0x48);  // 40
	...
	GC0329_write_cmos_sensor(0xa1, 0x3a);
	GC0329_write_cmos_sensor(0xa2, 0x50);
	GC0329_write_cmos_sensor(0xa3, 0x00);
	GC0329_write_cmos_sensor(0xa8, 0x00);
...
//			GC0329_write_cmos_sensor(0x77, 0x6c); //WB_manual_gain 
//			GC0329_write_cmos_sensor(0x78, 0x50);
//			GC0329_write_cmos_sensor(0x79, 0x40);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x46);
			GC0329_write_cmos_sensor(0x77, 0x6c);
...
//			GC0329_write_cmos_sensor(0x79, 0x40);	
			GC0329_write_cmos_sensor(0x42, 0xff); 
			GC0329_write_cmos_sensor(0xd3, 0x40);			
		break;
		
		case AWB_MODE_INCANDESCENT: //office
			GC0329_awb_enable(KAL_FALSE);
//			GC0329_write_cmos_sensor(0x77, 0x45);
//			GC0329_write_cmos_sensor(0x78, 0x45);
//			GC0329_write_cmos_sensor(0x79, 0x55);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x44);
			GC0329_write_cmos_sensor(0x77, 0x50);
			GC0329_write_cmos_sensor(0x78, 0x40);
			GC0329_write_cmos_sensor(0x79, 0x68);
		...
		case AWB_MODE_FLUORESCENT:
			GC0329_awb_enable(KAL_FALSE);
//			GC0329_write_cmos_sensor(0x77, 0x75);
//			GC0329_write_cmos_sensor(0x78, 0x50);
//			GC0329_write_cmos_sensor(0x79, 0x40);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x46);
		...
		case AWB_MODE_SHADE:
			GC0329_awb_enable(KAL_FALSE);
//			GC0329_write_cmos_sensor(0x77, 0x7a);
//			GC0329_write_cmos_sensor(0x78, 0x56);
//			GC0329_write_cmos_sensor(0x79, 0x40);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x46);
			GC0329_write_cmos_sensor(0x77, 0x98);
			GC0329_write_cmos_sensor(0x78, 0x58);
			GC0329_write_cmos_sensor(0x79, 0x40);
...
//			GC0329_write_cmos_sensor(0x79, 0x53);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x46);
			GC0329_write_cmos_sensor(0x77, 0x50);
			GC0329_write_cmos_sensor(0x78, 0x40);
...
//			GC0329_write_cmos_sensor(0x77, 0x45);
//			GC0329_write_cmos_sensor(0x78, 0x45);
//			GC0329_write_cmos_sensor(0x79, 0x5a);
			GC0329_write_cmos_sensor(0x42, 0xfd); 
			GC0329_write_cmos_sensor(0xd3, 0x46);
			GC0329_write_cmos_sensor(0x77, 0x50);
			GC0329_write_cmos_sensor(0x78, 0x40);
...
BOOL GC0329_set_param_effect(UINT16 para)
{
	...
	{
		case MEFFECT_OFF:
			printk("GC0329_set_param_effect MEFFECT_OFF\n");
			GC0329_write_cmos_sensor(0x43 , 0x00);
			
			GC0329_write_cmos_sensor(0x91 , 0x00);
			GC0329_write_cmos_sensor(0xd3 , 0x40);		
			GC0329_write_cmos_sensor(0xd4 , 0x80);			
			break;
		
		case MEFFECT_SEPIA:
			printk("GC0329_set_param_effect MEFFECT_SEPIA\n");
		...
		case MEFFECT_NEGATIVE:
			printk("GC0329_set_param_effect MEFFECT_NEGATIVE\n");
			...
			GC0329_write_cmos_sensor(0xd4 , 0x80);				
			break;
//		case MEFFECT_SEPIA_BLUE:
//			printk("GC0329_set_param_effect MEFFECT_SEPIA_BLUE\n");
//			GC0329_write_cmos_sensor(0x43 , 0x02);
...
//			break;		
		case MEFFECT_AQUA:
			printk("GC0329_set_param_effect MEFFECT_AQUA\n");
			GC0329_write_cmos_sensor(0x43 , 0x02);
			GC0329_write_cmos_sensor(0xda , 0x50);
			GC0329_write_cmos_sensor(0xdb , 0xe0);
		...
		case MEFFECT_BLACKBOARD:
			printk("GC0329_set_param_effect MEFFECT_BLACKBOARD\n");
			GC0329_write_cmos_sensor(0x43 , 0x02);
			GC0329_write_cmos_sensor(0xda , 0x00);
			GC0329_write_cmos_sensor(0xdb , 0x00);
			
			GC0329_write_cmos_sensor(0x91 , 0x01);
			GC0329_write_cmos_sensor(0xd3 , 0x98);		
			GC0329_write_cmos_sensor(0xd4 , 0xb0);
			break;
		case MEFFECT_WHITEBOARD:
			printk("GC0329_set_param_effect MEFFECT_WHITEBOARD\n");
//			 fe  00
			GC0329_write_cmos_sensor(0x43 , 0x03);
			GC0329_write_cmos_sensor(0xda , 0x00);
			GC0329_write_cmos_sensor(0xdb , 0x00);
			
			GC0329_write_cmos_sensor(0x91 , 0x01);
			GC0329_write_cmos_sensor(0xd3 , 0x60);		
			GC0329_write_cmos_sensor(0xd4 , 0x40);

			break;

		case MEFFECT_MONO:
			printk("GC0329_set_param_effect MEFFECT_MONO\n");
			GC0329_write_cmos_sensor(0x43 , 0x02);
			GC0329_write_cmos_sensor(0xda , 0x00);
			GC0329_write_cmos_sensor(0xdb , 0x00);
			...
			break;
		default:
			printk("GC0329_set_param_effect default\n");
			ret = FALSE;
			break;
	}
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_write_cmos_sensor(0x06, 0xfa); 
			GC0329_write_cmos_sensor(0x07, 0x00);
			GC0329_write_cmos_sensor(0x08, 0xd4);
			...
			GC0329_write_cmos_sensor(0x2c, 0xbc); 
			GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 1  12.50fps
			GC0329_write_cmos_sensor(0x2e, 0x20); 
			GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 2  10.00fps  03c0
			GC0329_write_cmos_sensor(0x30, 0x14); 
			GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 3  7.14fps  0540
			GC0329_write_cmos_sensor(0x32, 0xd0); 
			GC0329_SET_PAGE0;
			break;
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 0  10.00fps   03a8
			GC0329_write_cmos_sensor(0x30, 0x14); 
			GC0329_write_cmos_sensor(0x31, 0x07);   //exp level 0  7.05fps  052e
			GC0329_write_cmos_sensor(0x32, 0xd0); 
			GC0329_SET_PAGE0;
		break;
		default:
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	...
	value_Y = (GC0329_NIGHT_MODE?0x80:0x78);
