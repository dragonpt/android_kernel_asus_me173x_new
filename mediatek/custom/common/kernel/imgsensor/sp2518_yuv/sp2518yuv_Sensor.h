...
typedef enum _SP2518_OP_TYPE_ {
        SP2518_MODE_NONE,
        SP2518_MODE_PREVIEW,
        SP2518_MODE_CAPTURE,
        SP2518_MODE_QCIF_VIDEO,
        SP2518_MODE_CIF_VIDEO,
        SP2518_MODE_QVGA_VIDEO
    } SP2518_OP_TYPE;

extern SP2518_OP_TYPE SP2518_g_iSP2518_Mode;
 
/* sensor size */
#define SP2518_IMAGE_SENSOR_SVGA_WIDTH          (800)
#define SP2518_IMAGE_SENSOR_SVGA_HEIGHT         (600)
#define SP2518_IMAGE_SENSOR_UVGA_WITDH        (1600) 
#define SP2518_IMAGE_SENSOR_UVGA_HEIGHT       (1200) 

/* Sesnor Pixel/Line Numbers in One Period */	
#define SP2518_PV_PERIOD_PIXEL_NUMS    		(1300)  		/* Default preview line length */
#define SP2518_PV_PERIOD_LINE_NUMS     		(616)   	/* Default preview frame length */
#define SP2518_FULL_PERIOD_PIXEL_NUMS  		(1951)  	/* Default full size line length */
#define SP2518_FULL_PERIOD_LINE_NUMS   		(1232)  	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define SP2518_PV_EXPOSURE_LIMITATION      	(616-4)
#define SP2518_FULL_EXPOSURE_LIMITATION    	(1232-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define SP2518_PV_GRAB_START_X 				(5)
#define SP2518_PV_GRAB_START_Y  			(5)
#define SP2518_PV_GRAB_WIDTH				(SP2518_IMAGE_SENSOR_SVGA_WIDTH - 8 - 16)
#define SP2518_PV_GRAB_HEIGHT				(SP2518_IMAGE_SENSOR_SVGA_HEIGHT - 6 - 16)

#define SP2518_FULL_GRAB_START_X   			(5)
#define SP2518_FULL_GRAB_START_Y	  		(5)
#define SP2518_FULL_GRAB_WIDTH				(SP2518_IMAGE_SENSOR_UVGA_WITDH - 16 - 16)
#define SP2518_FULL_GRAB_HEIGHT				(SP2518_IMAGE_SENSOR_UVGA_HEIGHT - 12 - 16)

/*50Hz,60Hz*/
#define SP2518_NUM_50HZ                        (50 * 2)
#define SP2518_NUM_60HZ                        (60 * 2)

/* FRAME RATE UNIT */
#define SP2518_FRAME_RATE_UNIT                 (10)

/* MAX CAMERA FRAME RATE */
#define SP2518_MAX_CAMERA_FPS                  (SP2518_FRAME_RATE_UNIT * 30)
