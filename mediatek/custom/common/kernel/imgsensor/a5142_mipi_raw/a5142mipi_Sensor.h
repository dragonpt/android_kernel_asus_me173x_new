...
#define A5142MIPI_DATA_FORMAT SENSOR_OUTPUT_FORMAT_RAW_B //superdragonpt > 0
...
#define A5142MIPI_IMAGE_SENSOR_FULL_WIDTH       (A5142MIPI_IMAGE_SENSOR_FULL_HACTIVE - 32)  //2592-32 2560  //superdragonpt ok
#define A5142MIPI_IMAGE_SENSOR_FULL_HEIGHT      (A5142MIPI_IMAGE_SENSOR_FULL_VACTIVE - 24)  //1944 -24 1920 //superdragonpt ok

#define A5142MIPI_PV_START_X                    (2)
#define A5142MIPI_PV_START_Y                    (2+1)
#define A5142MIPI_IMAGE_SENSOR_PV_WIDTH         (A5142MIPI_IMAGE_SENSOR_PV_HACTIVE - 16)    //1296 -16 1280 //superdragonpt ok
#define A5142MIPI_IMAGE_SENSOR_PV_HEIGHT        (A5142MIPI_IMAGE_SENSOR_PV_VACTIVE - 12)    //972 -12 960 //superdragonpt ok
...
#define A5142MIPI_PV_PERIOD_PIXEL_NUMS              (A5142MIPI_IMAGE_SENSOR_PV_HACTIVE + A5142MIPI_IMAGE_SENSOR_PV_HBLANKING)      //1296 +1855 =3151 //superdragonpt ok
#define A5142MIPI_PV_PERIOD_LINE_NUMS               (A5142MIPI_IMAGE_SENSOR_PV_VACTIVE + A5142MIPI_IMAGE_SENSOR_PV_VBLANKING)      //972 + 128 =1100 //superdragonpt ok
