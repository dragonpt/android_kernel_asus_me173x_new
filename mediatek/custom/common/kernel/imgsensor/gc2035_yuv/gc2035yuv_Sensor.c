...
static void GC2035_Sensor_Init(void)
{
	...
	////////////YCP//////////
	GC2035_write_cmos_sensor(0xd1 , 0x30);//saturation_cb // 0x38  20130219
	GC2035_write_cmos_sensor(0xd2 , 0x30);//saturation_Cr // 0x38  20130219
	GC2035_write_cmos_sensor(0xd3 , 0x44);//contrast Ó // 0x40  20130219
	GC2035_write_cmos_sensor(0xd4 , 0x80);//contrast center 
	GC2035_write_cmos_sensor(0xd5 , 0xfc);//luma_offset // 0x00  20130219
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x84);// 0x80  20130219
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
