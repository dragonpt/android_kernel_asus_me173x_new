...
MSDK_SCENARIO_ID_ENUM S5K3H2CurrentScenarioId = MSDK_SCENARIO_ID_CAMERA_PREVIEW;
...
UINT32 S5K3H2YXMIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    S5K3H2CurrentScenarioId = ScenarioId;

        SENSORDB("[S5K3H2YXMIPIControl] %d\n", ScenarioId);
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PERIOD:
			switch(S5K3H2CurrentScenarioId)
			{
              case MSDK_SCENARIO_ID_CAMERA_ZSD:
			  case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
